...
<body class="childrenBody">
	...
	<blockquote class="layui-elem-quote quoteBox">
		<form class="layui-form">
			...
			<div class="layui-inline">
				<a class="layui-btn add-btn" data-url="${ctx }/publicer/toAddForm"
	...
	<table class="layui-table"
		lay-data="{height:515, url:'${ctx }/publicer/forms', page:true, id:'list-table'}"
		lay-filter="list">
		<thead>
			<tr>
	...
	<script type="text/html" id="deadlineTpl">
		<div>{{layui.util.toDateString(d.deadline, 'yyyy-MM-dd HH:mm:ss')}}</div>
	</script>
