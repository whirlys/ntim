...
<body class="childrenBody">
	...
	<blockquote class="layui-elem-quote quoteBox">
		<form class="layui-form">
			...
			<div class="layui-inline">
				<a class="layui-btn add-btn" data-url="${ctx }/publicer/toAddNotice"
	...
	<table class="layui-table"
		lay-data="{height:515, url:'${ctx }/publicer/notices', page:true, id:'list-table'}"
		lay-filter="list">
		<thead>
			<tr>
				<th lay-data="{field:'noticeId', width:80, sort: true}">ID</th>
				<th lay-data="{field:'title', width:250}">标题</th>
				<th lay-data="{field:'content', width:350, sort: true}">内容</th>
