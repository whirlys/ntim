...
public class MessageWrapper implements Serializable {
	...
	private String sessionId; // 请求人sessionId
	private String reSessionId; // 接收人sessionId
	private Integer fromUserId; // 请求人userId
	private Integer toId; // 接收人的Id
	private Object body;
	...
	public String toString() {
		return "MessageWrapper [protocol=" + protocol + ", sessionId=" + sessionId + ", reSessionId=" + reSessionId
